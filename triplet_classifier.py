# 12/16/2019: M.F. predictor_new.py，用于使用三重损失模型进行分类: 先不考虑图片的录入，直接使用离线图片作为新的类测试泛化能力。
...
model = load_model('C:/Users/Minghao/Desktop/dipper/new20classes-triplet-aug-50.h5',
